...
export const Pricing: React.FC<PricingProps> = ({ onClose, userEmail, userName }) => {
  ...
  const config = {
    ...
    customizations: {
      ...
      logo: 'https://ais-dev-3t4e3cwet4mpe2nggy3opj-33562663769.europe-west1.run.app/logo.png',
    },
  };
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/80 backdrop-blur-sm">
      <motion.div 
        ...
        className="max-w-5xl w-full bg-[#4A2C21] rounded-[40px] p-8 md:p-12 border border-white/10 shadow-2xl relative overflow-hidden"
      >
        <button 
          onClick={onClose}
